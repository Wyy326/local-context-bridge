...
| --- | --- | --- |
| `Local-Context-Bridge-v0.1.2-Windows-Portable.zip` | Complete portable package | The all-in-one archive. Unzip it and run the desktop executable. Includes README, license, and release notes. |
| `Local-Context-Bridge-v0.1.2-Windows-x64-setup.exe` | Most Windows users | NSIS installer with a familiar setup wizard. |
| `Local-Context-Bridge-v0.1.2-Windows-x64.msi` | Managed or enterprise-style installs | MSI package for Windows installer workflows. |
